                  ...
                  <div class="modal-body row" id="form-data">
                      ...
                      <div class="col-sm-8">
                          ...
                          <div class="row">
                              ...
                              <div class="form-group col"> <label for="edit-point">Point</label>
                                  <input type="number" class="form-control" id="edit-point" name="point" readonly>
                              </div>
                          </div>
                      </div>
                  </div>
      ...
      <script>
          ...
          $(document).ready(function() {
              $('#table').DataTable({
                  "ajax": "<?php echo base_url('customer/get') ?>",
                  "columns": [{
                      "render": function() {
                          return get_index();
                      },
